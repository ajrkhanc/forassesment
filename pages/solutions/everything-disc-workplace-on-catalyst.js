            ...
            <div className="container-full">
                <div className="row y-middle">
                    <div className="col-lg-12">
                      <img className="img100" src="/assets/img/banner/ed-catal.jpg"/>
                    </div>         
                </div>
            </div>
            </div>
            ...
            <div className="container">
                <div className="row rs-vertical-middle">
                    ...
                    <div className="col-lg-6 md-pt-50">
                        ...
                        <img src="/assets/img/everything-disc-workplace-on-catalyst.png" alt=""/>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="rs-addon-number">
                                    <div class="number-part">
                                        <div class="number-image">
                                            <img src="/assets/img/proses1.png" alt="Process"/>
                                        </div>
                            ...
                            <div class="col-sm-4 md-mb-30">
                                <div class="rs-addon-number">
                                    <div class="number-part">
                                        <div class="number-image">
                                        <img src="/assets/img/proses2.png" alt="Process"/>
                                        </div>
                                        <div class="number-text">
                            ...
                            <div class="col-sm-4 sm-mb-30">
                                <div class="rs-addon-number">
                                    <div class="number-part">
                                        <div class="number-image">
                                        <img src="/assets/img/proses3.png" alt="Process"/>
                                        </div>
                                        <div class="number-text">
