      ...
      <div className="row y-middle">
         ...
         <div className="col-lg-5">
            <div className="about-img">
               <img src="/assets/img/personal-development2.png" alt="images"/>
               <div className="animations one">
                  <img className="dance2" src="/assets/img/1.png" alt="About"/>
               </div>
               <div className="animations two">
                  <img className="scale" src="/assets/img/2.png" alt="About"/>
               </div>
            </div>
         </div>
      </div>
   ...
   <div className="container">
      ...
      <div className="row service-wrap mr-0 ml-0">
         <div className="col-lg-4 padding-0 pr-1">
            <div className="service-grid">
               <div className="service-icon mb-23">
                  <img src="/assets/img/icon/personal-development.png" alt=""/>
               </div>
         ...
         <div className="col-lg-4 padding-0">
            <div className="service-grid">
               <div className="service-icon mb-23">
                  <img src="/assets/img/icon/team-development.png" alt=""/>
               </div>
         ...
         <div className="col-lg-4 padding-0">
            <div className="service-grid">
               <div className="service-icon mb-23">
                  <img src="/assets/img/icon/virtual-teams.png" alt=""/>
               </div>
                           ...
                           <div className="pb-50">
                            ...
                            <Slider {...settings}>
                                    ...
                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c1.jpg"/>
                                    </div>
                                
                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c2.jpg"/>
                                    </div>
                                
                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c3.jpg"/>
                                    </div>
                                
                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c4.jpg"/>
                                    </div>
                               
                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c5.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c6.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c7.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c8.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c9.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c10.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c11.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c12.jpg"/>
                                    </div>

                                    <div className='logoslider'>                                
                                        <img src="/assets/img/logos/c13.jpg"/>
                                    </div>
